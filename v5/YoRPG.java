...
public class YoRPG
{
  ...
  System.out.println("You have chosen the path of a mage!");
       ...
       System.out.println("You have chosen the path of a marksman!");
    }
    else {
       pat = new Warrior(name);
  ...
  public boolean playTurn()
  {
    ...
    if ( Math.random() >= ( difficulty / 3.0 ) )
        ...
        try {
          System.out.println( "\nDo you feel lucky?" );
          System.out.println( "\t1: Nay.\n\t2: Aye!\n\t3: May the lords bless me with health. \n\t(While gaining health, monster may still attack and you are left vulnerable) " );
